package Session_12_MiniatureFramework_UsingJunit.utilities;
...
public class Utils_session12 {
	...
	// Class variables
		...
		public Properties init_prop()
		{
			prop = new Properties();
			try {
				//FileInputStream ip = new FileInputStream("C:\\Users\\hp\\eclipse-workspace\\Batch17SeleniumWebdriver\\src\\test\\java\\Session_12_MiniatureFramework_UsingJunit\\config.properties");
				FileInputStream ip = new FileInputStream(System.getProperty("user.dir") + "\\src\\test\\java\\Session_12_MiniatureFramework_UsingJunit\\config.properties");
				prop.load(ip);
