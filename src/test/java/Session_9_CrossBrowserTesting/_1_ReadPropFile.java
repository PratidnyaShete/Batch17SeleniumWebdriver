package Session_9_CrossBrowserTesting;
...
public class _1_ReadPropFile {
	...
	public void read_PropFile() throws InterruptedException
	{
		prop = new Properties();
		try {
			//FileInputStream ip = new FileInputStream(System.getProperty("user.dir") + "src\\test\\java\\Session_9_CrossBrowserTesting\\config_9.properties");
			FileInputStream ip = new FileInputStream("C:\\Users\\hp\\eclipse-workspace\\Batch17SeleniumWebdriver\\src\\test\\java\\Session_9_CrossBrowserTesting\\config_9.properties");
			prop.load(ip);
